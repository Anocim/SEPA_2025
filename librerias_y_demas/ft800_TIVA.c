...
void ajustaBrillo(int brillo){
    int aux;
    if(brillo<=20){
        HAL_SPI_CSLow();
        FT800_SPI_SendAddressWR(REG_PWM_DUTY);
        FT800_SPI_Write8(30); //Entre 0 y 128
        HAL_SPI_CSHigh();
    }
    else if(brillo<=500){
        aux=(int)round(0.2*brillo + 26);
        HAL_SPI_CSLow();
        FT800_SPI_SendAddressWR(REG_PWM_DUTY);
        FT800_SPI_Write8(aux); //Entre 0 y 128
        HAL_SPI_CSHigh();
    }
    else{
        HAL_SPI_CSLow();
        FT800_SPI_SendAddressWR(REG_PWM_DUTY);
        FT800_SPI_Write8(128); //Entre 0 y 128
        HAL_SPI_CSHigh();
    }
