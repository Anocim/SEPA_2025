 ...
 * Funciones de abstracci n del hardware, especificas del micro a usar
 * Accesos a los pines de E/S, al SPI, y a la configuraci n
 ********************************************/
 ...
 * de 8, 16 o 32 bits, de cualquier posici n interna de la pantalla
 *
 ********************************************************/
 ...
 * Inicializaci n de la pantalla, mandar comandos, y
 * usar algunos de los comandos disponibles.
 * NO TODOS LOS COMANDOS EST N DESARROLLADOS.
 *
 ***************************************************/
...
void ComSlider(int x, int y, int w, int h, int ops, int val, int size, int range);
